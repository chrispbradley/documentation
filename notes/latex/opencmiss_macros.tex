...
\newcommand{\gnuplotfigure}[7]{ %
  \begin{figure}[hbtp]
    \centering %
    \ifthenelse{\equal{#7}{}}{ %
      \gnuplotloadfile[terminal=pslatex,terminaloptions={color size #6,#6 #5}]{#1}}{ %
      \gnuplotloadfile[terminal=pslatex,terminaloptions={color size #6,#7 #5}]{#1} %
    } %
    \ifthenelse{\equal{#2}{}}{ %
      \caption{#3}}{ %
      \caption[#2]{#3} %
    ...
    \label{#4} %
  \end{figure}
} % gnuplot figure e.g. \gnuplotfigure{file}{short caption}{long caption}{label}{fontsize}{gnuplotxsize}{gnuplotysize}
...
\newcommand{\Appendthrurefs}[2]{Appendices~\ref{#1}--\ref{#2}} % Appendices-- ref.
\newcommand{\assumpref}[1]{Assumption~\ref{#1}} % Assumption reference
\newcommand{\Assumpref}[1]{Assumption~\ref{#1}} % Assumption reference
\newcommand{\assumprefstwo}[2]{Assumptions~\ref{#1} and~\ref{#2}} % Assumptions ref. two
\newcommand{\Assumprefstwo}[2]{Assumptions~\ref{#1} and~\ref{#2}} % Assumptions ref. two
\newcommand{\assumprefsthree}[3]{Assumptions~\ref{#1}, \ref{#2}, and~\ref{#3}} % Assumptions ref. three
\newcommand{\Assumprefsthree}[3]{Assumptions~\ref{#1}, \ref{#2}, and~\ref{#3}} % Assumptions ref. three
\newcommand{\assumprefsfour}[4]{Assumptions~\ref{#1}, \ref{#2}, \ref{#3}, and~\ref{#4}} % Assumptions ref. four
\newcommand{\Assumprefsfour}[4]{Assumptions~\ref{#1}, \ref{#2}, \ref{#3}, and~\ref{#4}} % Assumptions ref. four
\newcommand{\assumprefs}[2]{\assumprefstwo{#1}{#2}} % Assumptions ref.
\newcommand{\Assumprefs}[2]{\Assumprefstwo{#1}{#2}} % Assumptions ref.
\newcommand{\assumpthrurefs}[2]{Assumptions~\ref{#1}--\ref{#2}} % Assumptions-- ref.
\newcommand{\Assumpthrurefs}[2]{Assumptions~\ref{#1}--\ref{#2}} % Assumptions-- ref.
...
\newcommand{\ionGd}{\ion{Gd}{3+}} % gadolinium ion
\newcommand{\ionGa}{\ion{Ga}{3+}} % gallium ion
...
\newcommand{\gene}[1]{\ensuremath{\mathit{#1}}\xspace} % gene
\newcommand{\protein}[1]{\ensuremath{\mathbf{\mathit{#1}}}\xspace} % protein
\newcommand{\enzyme}[1]{\ensuremath{\mathrm{#1}}\xspace} % enzyme
...
\newcommand{\first}{\ensuremath{1^{\text{st}}}\xspace} % 1^st e.g. \first => 1^st
\newcommand{\second}{\ensuremath{2^{\text{nd}}}\xspace} % 2^nd e.g. \second => 2^nd
\newcommand{\third}{\ensuremath{3^{\text{rd}}}\xspace} % 3^rd e.g. \third => 3^rd
\newcommand{\nth}[1]{\ensuremath{{#1}^{\text{th}}}\xspace} % ^th e.g. \nth{n} => n^th
...
\newcommand{\nttunit}[3]{\ensuremath{ %
    #1\times 10^{#2}~#3 % 
    }} % number x10^? + unit e.g. \nttunit{10}{3}{\m} => 10x10^-3 m
\newcommand{\nrunit}[3]{\ensuremath{ %
    \nrange{#1}{#2}~#3 %
}} % number range + unit e.g. \nrunit{10}{20}{\m} => 10--20 m
\newcommand{\unitdimension}[2]{\ensuremath{ %
    \ifthenelse{\equal{#2}{}}{ %
      \brac{[}{#1}{]}
    }{ %
      {\brac{[}{#1}{]}}^{#2} %
    } %
}} % unit dimension e.g., \unitdimension{mm}{2} => [mm]^2
...
% Area
% Volume
\newcommand{\Litre}{\units{L}} % litres
\newcommand{\ml}{\units{ml}} % millilitres
\newcommand{\mL}{\units{mL}} % millilitres
\newcommand{\uL}{\units{\mu L}} % microlitres
\newcommand{\nL}{\units{nL}} % nanolitres
% Mass
...
\newcommand{\nanog}{\units{ng}} % nanograms
\newcommand{\pg}{\units{pg}} % picograms
% Time
\newcommand{\s}{\units{s}} % seconds
\newcommand{\ms}{\units{ms}} % milliseconds
\newcommand{\us}{\units{\mu s}} % microseconds
% Amount
\newcommand{\fmol}{\units{fmol}} % femtomoles
\newcommand{\pmol}{\units{pmol}} % picomoles
\newcommand{\nmol}{\units{nmol}} % nanomoles
\newcommand{\umol}{\units{\mu mol}} % micromoles
\newcommand{\mmol}{\units{mmol}} % millimoles
\newcommand{\mol}{\units{mol}} % moles
% Charge
...
\newcommand{\cellunit}{\units{cell}} % cell
\newcommand{\Da}{\units{Da}} % Dalton
\newcommand{\kDa}{\units{kDa}} % kilo-Dalton
\newcommand{\kat}{\units{kat}} % katal (enzyme activity)
\newcommand{\minute}{\units{min}} % minute
\newcommand{\minutes}{\units{mins}} % minutes
\newcommand{\hour}{\units{hour}} % hour
\newcommand{\hours}{\units{hours}} % hours
\newcommand{\week}{\units{week}} % week
\newcommand{\weeks}{\units{weeks}} % weeks
\newcommand{\nTPM}{\units{nTPM}} % normalised transcripts per million
...
\newcommand{\mLpms}{\units{\mL\unitseparator\ms^{-1}}} % milli-litres/milli-second
\newcommand{\mLpminute}{\units{\mL\unitseparator\minute^{-1}}} % milli-litres/minute
\newcommand{\uLpminute}{\units{\uL\unitseparator\minute^{-1}}} % microlitres/minute
\newcommand{\uLpminutepg}{\units{\mL\unitseparator\minute^{-1}}\unitseparator\g^{-1}} % microlitres/minute/g
\newcommand{\mLpg}{\units{\mL\unitseparator\g^{-1}}} % millilitres/g
\newcommand{\Lpcell}{\units{L\unitseparator\cellunit^{-1}}} % litres/cell
...
\newcommand{\mmpweek}{\units{\mm\unitseparator\week^{-1}}} % millimetres/week
...
\newcommand{\permol}{\units{\mol^{-1}}} % per mole
...
\newcommand{\umolpL}{\units{\umol\unitseparator L^{-1}}} %micromoles per Litre
\newcommand{\mmolpmL}{\units{\mmol\unitseparator\mL^{-1}}} %milli-moles per millilitre
\newcommand{\umolpmL}{\units{\umol\unitseparator\mL^{-1}}} %micro-moles per millilitre
\newcommand{\nmolpmL}{\units{\nmol\unitseparator\mL^{-1}}} %nano-moles per millilitre
\newcommand{\pmolpmL}{\units{\pmol\unitseparator\mL^{-1}}} %pico-moles per millilitre
\newcommand{\fmolpmL}{\units{\fmol\unitseparator\mL^{-1}}} %femto-moles per millilitre
\newcommand{\mmolpmg}{\units{\mmol\unitseparator\mg^{-1}}} %milli-moles per milligram
\newcommand{\umolpmg}{\units{\umol\unitseparator\mg^{-1}}} %micro-moles per milligram
\newcommand{\nmolpmg}{\units{\nmol\unitseparator\mg^{-1}}} %nano-moles per milligram
\newcommand{\pmolpmg}{\units{\pmol\unitseparator\mg^{-1}}} %pico-moles per milligram
\newcommand{\fmolpmg}{\units{\fmol\unitseparator\mg^{-1}}} %femto-moles per milligram
\newcommand{\pmolpg}{\units{\pmol\unitseparator\g^{-1}}} %picomoles per gram
\newcommand{\mmolpLpms}{\units{\mmol\unitseparator L^{-1}\unitseparator\ms^{-1}}} %milli-moles per Litre per millisecond
\newcommand{\umolpLpminute}{\units{\umol\unitseparator L^{-1}\unitseparator\minute^{-1}}} %micro-moles per Litre per minute
\newcommand{\umolpminute}{\units{\umol\unitseparator\minute^{-1}}} %pico-moles per minute
\newcommand{\pmolpmLpms}{\units{\pmol\unitseparator\mL^{-1}\unitseparator\ms^{-1}}} %picomoles per millilitre per millisecond
\newcommand{\pmolpmspmL}{\units{\pmol\unitseparator\ms^{-1}\unitseparator\mL^{-1}}} %picomoles per millisecond per millilitre 
\newcommand{\pmolpmspmg}{\units{\pmol\unitseparator\ms^{-1}\unitseparator\mg^{-1}}} %picomoles per millisecond per milligram 
\newcommand{\pmolpms}{\units{\pmol\unitseparator\ms^{-1}}} %pico-moles per millisecond
\newcommand{\kgpL}{\units{\kg\unitseparator\Litre^{-1}}} %kilograms per Litre
\newcommand{\gpmL}{\units{\g\unitseparator\mL^{-1}}} %grams per millilitre
\newcommand{\mgpml}{\units{\mg\unitseparator\ml^{-1}}} %milligrams per millilitre
\newcommand{\mgpmL}{\units{\mg\unitseparator\mL^{-1}}} %milligrams per millilitre
\newcommand{\ugpml}{\units{\ug\unitseparator\ml^{-1}}} %micrograms per millilitre
\newcommand{\ugpmL}{\units{\ug\unitseparator\mL^{-1}}} %micrograms per millilitre
\newcommand{\ngpml}{\units{\ng\unitseparator\ml^{-1}}} %nanograms per millilitre
\newcommand{\ngpmL}{\units{\ng\unitseparator\mL^{-1}}} %nanograms per millilitre
\newcommand{\pgpml}{\units{\pg\unitseparator\ml^{-1}}} %picograms per millilitre
\newcommand{\pgpmL}{\units{\pg\unitseparator\mL^{-1}}} %picograms per millilitre
\newcommand{\mVpms}{\units{\mV\unitseparator\ms^{-1}}} %microvolts per millisecond
\newcommand{\mgpmg}{\units{\mg\unitseparator\mg^{-1}}} % milligram per milligram
\newcommand{\mgpg}{\units{\mg\unitseparator\g^{-1}}} % milligram per gram
\newcommand{\mgpkg}{\units{\mg\unitseparator\kg^{-1}}} % milligram per kilogram
\newcommand{\gpg}{\units{\g\unitseparator\g^{-1}}} % gram per gram
\newcommand{\gpmol}{\units{\g\unitseparator\mol^{-1}}} % gram per mole
\newcommand{\gppmol}{\units{\g\unitseparator\pmol^{-1}}} % gram per picomole
...
%generic operators
\DeclareMathOperator{\signop}{sign} % sign operator e.g., sign A
\DeclareMathOperator{\modop}{mod} % modulus operator e.g., mod A
...
characterised as L-cystine
aminopeptidase (or CAP). Differences in this cleavage result in   \ifthenelse{\equal{#1}{}}{ %
    \ensuremath{\fnof{D}{#2}}
  }{
...
\newcommand{\functionaloperator}[2]{\ensuremath{ %
    \ifthenelse{\equal{#2}{}}{ %
      \mathcal{#1}}{ %
      \brfnof{\mathcal{#1}}{#2} %
    } %    
}} % Functional operator e.g., \functionaloperator{L}{x} => L{x}
\newcommand{\indexfunctionaloperator}[3]{\ensuremath{ %
    \ifthenelse{\equal{#3}{}}{ %
      \mathcal{#1}_{#2}}{ %
      \brfnof{\mathcal{#1}_{#2}}{#3} %
    } %    
}} % Indexed functional operator e.g., \functionaloperator{L}{j}{x} => L_j{x}
\newcommand{\koopmanoperatorsymbol}{\ensuremath{ %
    K %
}} % Koopman operator symbol
\newcommand{\koopmanoperator}[1]{\ensuremath{ %
    \functionaloperator{\koopmanoperatorsymbol}{#1} %
}} % Koopman operator i.e., \koopmanoperator{x} => K{x}
\newcommand{\lieoperatorsymbol}{\ensuremath{ %
    L %
}} % Lie operator symbol
\newcommand{\lieoperator}[1]{\ensuremath{ %
    \functionaloperator{\lieoperatorsymbol}{#1} %
}} % Lie operator i.e., \lieoperator{x} => L{x}
\newcommand{\perronfrobeniusoperatorsymbol}{\ensuremath{ %
    P %
}} % Perron-Frobenius operator symbol
\newcommand{\perronfrobeniusoperator}[1]{\ensuremath{ %
    \functionaloperator{\perronfrobeniusoperatorsymbol}{#1} %
}} % Perron-Frobenius operator i.e., \perronfrobeniusoperator => P

\newcommand{\gradientoperatorsymbol}{\ensuremath{ %
    G %
}} % Gradient operator symbol
\newcommand{\gradientoperator}[2]{\ensuremath{ %
    \indexfunctionaloperator{\gradientoperatorsymbol}{#1}{#2} %
}} % Gradient operator i.e., \gradientoperator{j}{x} => G_j{x}
\newcommand{\tildegradientoperator}[2]{\ensuremath{ %
    \indexfunctionaloperator{\tilde{\gradientoperatorsymbol}}{#1}{#2} %
}} % Tilde gradient operator i.e., \tildegradientoperator{j}{x} => ~G_j{x}
\newcommand{\diffusionoperatorsymbol}{\ensuremath{ %
    D %
}} % Diffusion operator symbol
\newcommand{\diffusionoperator}[2]{\ensuremath{ %
    \indexfunctionaloperator{\diffusionoperatorsymbol}{#1}{#2} %
}} % Diffusion operator i.e., \diffusionoperator{j}{x} => D_j{x}
\newcommand{\tildediffusionoperator}[2]{\ensuremath{ %
    \indexfunctionaloperator{\tilde{\diffusionoperatorsymbol}}{#1}{#2} %
}} % Tilde diffusion operator i.e., \tildediffusionoperator{j}{x} => ~D_j{x}
...
}} % Jacobian. e.g. \jacobian{a}{b} => J_a(b)
...
% Other functions
%
\newcommand{\greensfunctionsymbol}{\ensuremath{G}} % \greensfunctionsymbol
\newcommand{\greensfunction}[2]{\ensuremath{ %
    \ifthenelse{\equal{#1}{}}{ %
      \fnof{\greensfunctionsymbol}{#1} %
    }{ %
      \fnof{\greensfunctionsymbol}{#1,#2} %
    }
}} % \greensfunction{x}{x_0} => G(x,x_0)
\newcommand{\deltafunction}[1]{\ensuremath{ %
    \fnof{\delta}{#1} %
}} % \deltafunction{x} => \delta(x)
